...
public:
  ...
  {}
  ::btcpp_ros2_interfaces::action::ExecuteTree_Goal target_tree(::btcpp_ros2_interfaces::action::ExecuteTree_Goal::_target_tree_type arg)
  {
...
{
public:
  explicit Init_ExecuteTree_Result_node_status(::btcpp_ros2_interfaces::action::ExecuteTree_Result & msg)
  : msg_(msg)
  {}
  ::btcpp_ros2_interfaces::action::ExecuteTree_Result node_status(::btcpp_ros2_interfaces::action::ExecuteTree_Result::_node_status_type arg)
  {
...
class Init_ExecuteTree_Result_error_message
{
public:
  Init_ExecuteTree_Result_error_message()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ExecuteTree_Result_node_status error_message(::btcpp_ros2_interfaces::action::ExecuteTree_Result::_error_message_type arg)
  {
    msg_.error_message = std::move(arg);
    return Init_ExecuteTree_Result_node_status(msg_);
  }
...
{
  return btcpp_ros2_interfaces::action::builder::Init_ExecuteTree_Result_error_message();
}
...
class Init_ExecuteTree_Feedback_msg
{
public:
  Init_ExecuteTree_Feedback_msg()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::btcpp_ros2_interfaces::action::ExecuteTree_Feedback msg(::btcpp_ros2_interfaces::action::ExecuteTree_Feedback::_msg_type arg)
  {
...
{
  return btcpp_ros2_interfaces::action::builder::Init_ExecuteTree_Feedback_msg();
}
