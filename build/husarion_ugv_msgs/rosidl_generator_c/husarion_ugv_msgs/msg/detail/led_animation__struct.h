...
enum
{
  husarion_ugv_msgs__msg__LEDAnimation__MANUAL_ACTION = 3
};

/// Constant 'AUTONOMOUS_ACTION'.
enum
{
  husarion_ugv_msgs__msg__LEDAnimation__AUTONOMOUS_ACTION = 4
};

/// Constant 'GOAL_ACHIEVED'.
enum
{
  husarion_ugv_msgs__msg__LEDAnimation__GOAL_ACHIEVED = 5
};

/// Constant 'LOW_BATTERY'.
enum
{
  husarion_ugv_msgs__msg__LEDAnimation__LOW_BATTERY = 6
};

/// Constant 'CRITICAL_BATTERY'.
enum
{
  husarion_ugv_msgs__msg__LEDAnimation__CRITICAL_BATTERY = 7
};

/// Constant 'BATTERY_STATE'.
enum
{
  husarion_ugv_msgs__msg__LEDAnimation__BATTERY_STATE = 8
};

/// Constant 'CHARGING_BATTERY'.
enum
{
  husarion_ugv_msgs__msg__LEDAnimation__CHARGING_BATTERY = 9
};
