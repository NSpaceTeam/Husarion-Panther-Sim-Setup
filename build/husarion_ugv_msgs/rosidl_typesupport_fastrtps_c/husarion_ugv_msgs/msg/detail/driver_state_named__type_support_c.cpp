  ...
  // Field name: state
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, husarion_ugv_msgs, msg, DriverState
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _DriverStateNamed__ros_msg_type * ros_message = static_cast<_DriverStateNamed__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
