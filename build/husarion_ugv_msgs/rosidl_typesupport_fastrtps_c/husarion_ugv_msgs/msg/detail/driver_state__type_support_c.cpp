  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fault_flag
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, husarion_ugv_msgs, msg, FaultFlag
      )()->data);
  ...
  // Field name: script_flag
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, husarion_ugv_msgs, msg, ScriptFlag
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: channel_1_motor_runtime_error
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, husarion_ugv_msgs, msg, RuntimeError
      )()->data);
    if (!callbacks->cdr_serialize(
